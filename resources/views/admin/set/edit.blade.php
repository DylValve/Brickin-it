...
<div class="top-bar">
    <div class="top-bar-left">
        <ul class="dropdown menu" data-dropdown-menu>
            ...
            <li><a href="{{route('sets.create')}}">Add Sets</a></li>
        </ul>
    </div>
</div>
    ...
    <table class="w-75">
        ...
        <tr>
            <td class="flex justify-center">
                <form method="POST" action="{{route('sets.update', $set)}}">
                    @method('PUT')
                    @csrf
                    <ol>
                        <label for="Setname">Name :</label>
                        <input type="text" id="Setname" name="name" value="{{old('name')??$set->name}}">
                        <label for="Setnumber">Set Number :</label>
                        <input type="text" id="Setnumber" name="set_number" value="{{old('set_number')??$set->set_number}}">

                        <label for="themeid"> Theme:</label>
                        <select name="theme_id" id="themeid">
