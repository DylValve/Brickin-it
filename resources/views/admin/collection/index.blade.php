    ...
    <div class="grid-container">
        <div class="grid-x">
            <div class="cell small-12">
                ...
                <h1 class="text-center">All Collection</h1>
                    ...
                    @forelse($collections as $collection)
                        <tr class="table-expand-row" data-open-details>
                            ...
                            <td class="flex justify-center">
                                <a href="{{route('collections.show',$collection)}}" class="button button-primary"
                                   type="submit">view</a>
                                <a href="{{route('collections.edit',$collection)}}" class="button button-primary"
                                   type="submit">edit</a>
