            ...
            <td class="flex justify-center">
                <form method="POST" action="{{route('collections.update', $collection)}}">
                    ...
                    <ol>
                        ...
                        <input type="text" id="collectionName" name='name' value="{{old('name') ?? $collection->name}}">
                        <label for="collectionUserId">UserId:</label>
                        <input type="number" id="collectionUserId" name='user_id' value="{{old('user_id') ?? $collection->user_id}}">
