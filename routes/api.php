...
Route::get('alt-collections/sets/{collection_id}', [APICollectionSetFixController::class, "altCollectionSetSearch"]);
Route::get('collections/alt-Show/{set_id}/{collection_id}', [APICollectionSetFixController::class, "altShow"]);
